<?php
    ...
    if (!isset($_SESSION['admin'])) {
        echo "<script> alert('Anda Belum Login, Silahkan Tekan Ok Untuk Melanjutkan Login'); </script>";
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation">
            ...
            <div id="logout"style="padding: 15px 50px 5px 50px;">
           ...
           <!-- /. NAV TOP  -->
            <nav class="navbar-default navbar-side " role="navigation">
                <div class="sidebar-collapse" style="background: orange; color: white">
                    <ul class="nav" id="main-menu">
                        <li class="text-center">
                            <img src="assets/img/administrator.png" class="user-image img-responsive" style=" width: 300px; " />
                        </li> 
